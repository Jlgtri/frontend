                        ...
                        <Box className="bg-color191919 rounded-lg p-4 h-full">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-3 bg-black px-4 py-1.5 rounded">
                              ...
                              <div className="text-Greens font-normal text-sm uppercase">
                                {item.status}
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="privateSale_list">
                            <ul>
                              <li className="my-5 flex items-center gap-5 justify-between">
                                <span className="text-white w-1/2 text-right">
                                  Tokens :
                                </span>
                                <span className="text-Greens w-1/2">
                                  {getMe2DecimalPointsWithCommas(item.tokens)}{' '}
                                  BLOX
                                </span>
                              </li>
                              <li className="my-5 flex items-center gap-5 justify-between">
