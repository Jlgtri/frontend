...
const Home = () => {
  ...
  console.log('activePresale', activePresale);
                  ...
                  <div className="my-5">
                    {isConnected ? (
                      loading ? (
                        ...
                        <button
                          disabled={targetDate === 0 ? true : timeLeft > 0}
            ...
            <Grid
              ...
              <Box className="my-5">
                <div className="text-center text-white mb-3">
                  ...
                  Plus, it includes an affilite program where users an earn
                  even more by initing others to join this exciting staking
                  opportunity.
                </div>
